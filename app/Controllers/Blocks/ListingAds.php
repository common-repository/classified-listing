...
class ListingAds
{
	...
	public function get_attributes($default = false)
	{
		$attributes = array(
			...
			"customFieldLabelColor" => array(
				"type" => "string",
				"default" => "",
				'style'   => [(object)['selector' => '{{RTCL}} .rtcl.rtcl-gb-block .rtcl-listable .rtcl-listable-item .listable-label
				{color:{{customFieldLabelColor}} !important;}']]
			),
			"customFieldValColor" => array(
				"type" => "string",
				"default" => "",
				'style'   => [(object)['selector' => '{{RTCL}} .rtcl.rtcl-gb-block .rtcl-listable .rtcl-listable-item .listable-value,
				{{RTCL}} .rtcl.rtcl-gb-block .rtcl-listable .rtcl-listable-item:after
				{color:{{customFieldValColor}} !important;}']]
			),
	...
	public function register_listings()
	{
		...
		register_block_type(
			RTCL_PATH . 'block-metadata/listing-ads',
			[
