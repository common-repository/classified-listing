					...
					if ( rtcl()->has_pro() ) {
						if ( ! empty( $instance['rtcl_show_quick_view'] ) ) :
							...
							<div class="rtcl-el-button">
								<a class="rtcl-quick-view" href="#" title="<?php esc_attr_e( 'Quick View', 'classified-listing' ); ?>"
						...
						if ( ! empty( $instance['rtcl_show_compare'] ) ) :
							...
							<div class="rtcl-el-button">
								...
								<a class="rtcl-compare <?php echo esc_attr( $selected_class ); ?>" href="#"
								   title="<?php esc_attr_e( 'Compare', 'classified-listing' ); ?>" data-listing_id="<?php echo absint( $_id ); ?>">
