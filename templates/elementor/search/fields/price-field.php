...
<?php if ( $settings['price_field'] ) : ?>
	<div class="form-group  ws-item ws-price  price-field col-md-6 col-xs-6">
		...
		<?php } ?>
		<?php $min_price = isset( $_GET['filters']['price']['min'] ) ? $_GET['filters']['price']['min'] : ''; /* phpcs:ignore WordPress.Security.NonceVerification.Recommended */ ?>
	...
	<div class="form-group ws-item ws-price  price-field col-md-6 col-xs-6">
		...
		<?php } ?>
		<?php $max_price = isset( $_GET['filters']['price']['max'] ) ? $_GET['filters']['price']['max'] : ''; /* phpcs:ignore WordPress.Security.NonceVerification.Recommended */ ?>
