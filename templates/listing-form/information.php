...
<div class="rtcl-post-details rtcl-post-section">
	...
	<?php if ( ! in_array( 'description', $hidden_fields ) ): ?>
		<div
			class="form-group" <?php echo $description_limit ? 'data-max-length="' . esc_attr( $description_limit ) . '"' : ''; ?>>
	...
	<?php if ( ! in_array( 'tags', $hidden_fields ) ): ?>
		<div class="form-group">
			<label for="description"><?php esc_html_e( 'Tags', 'classified-listing' ); ?></label>
