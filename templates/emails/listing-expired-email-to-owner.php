...
do_action( 'rtcl_email_header', $email ); ?>
	<p><?php printf( /* translators: Owner name */ esc_html__( 'Hi %s,', 'classified-listing' ), esc_html( $listing->get_owner_name() ) ); ?></p>
	<p><?php
		// phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped
		printf(
		/* translators: Listing expired link */
			__( 'Your listing %1$s is expired on %2$s. You can renew it here: %3$s', 'classified-listing' ),
