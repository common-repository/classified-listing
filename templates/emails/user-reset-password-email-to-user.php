...
do_action( 'rtcl_email_header', $email ); ?>
    ...
    <p><?php /* translators:  new registration */ printf( esc_html__( 'Someone has requested a new password for the following account on %s:', 'classified-listing' ), esc_html(Functions::get_blogname()) ); ?></p>
